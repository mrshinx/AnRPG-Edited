                ...
                case Message.SyncLevel:
                    ...
                    */
                    ...
                    if((int)tags[DataTag.playerId] != Main.myPlayer)
                    {
                        ...
                        if (Main.netMode != NetmodeID.Server)
                        {
                            Main.player[(int)tags[DataTag.playerId]].statLife = (int)tags[DataTag.life];
                            Main.player[(int)tags[DataTag.playerId]].statLifeMax2 = (int)tags[DataTag.maxLife];
                ...
                case Message.SyncNPCUpdate:
                    if (Main.netMode == NetmodeID.MultiplayerClient)
                    {
                        ...
                        if (npcu.lifeMax != (int)tags[DataTag.maxLife] || npcu.life != (int)tags[DataTag.life])
                        {
                            ...
                            AskNpcInfo(AnotherRpgMod.Instance, npcu);
                        }
