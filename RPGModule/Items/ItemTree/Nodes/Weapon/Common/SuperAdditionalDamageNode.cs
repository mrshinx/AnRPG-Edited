...
namespace AnotherRpgMod.Items
{
    class SuperAdditionalDamageNode : ItemNode
    {
        ...
        public override string GetDesc { get {
               ...
               // return "Flat damage: " + FlatDamage + " level: " + Utils.Mathf.Clamp(GetLevel,1,GetMaxLevel);
            } }
        ...
        {
            FlatDamage = Utils.Mathf.Clamp((int)(value*1.01),2,999);
            m_MaxLevel = 1;
            m_RequiredPoints = 1 + Utils.Mathf.FloorInt(value * 0.4f);
            power = value;
        }
