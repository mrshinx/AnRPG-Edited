...
namespace AnotherRpgMod
{
     ...
     public class JsonNodeList
    {
        public JsonNode[] jsonList = {
            ...
            new JsonNode("Damage",-400,400,false,new int[2]{22,23},"Melee",false,0.06f,75,80,10),//34
            ...
            new JsonNode("Damage",900,700,false,new int[1]{102},"Magic",false,0.15f,160,30,25), //103
            ...
            new JsonNode("Damage",900,-250,false,new int[1]{108},"Summon",false,0.05f,120,10,15), //109
            ...
            new JsonNode("Damage",1100,-150,false,new int[1]{111},"Summon",false,0.05f,160,20,25), //112
            ...
            new JsonNode("Damage",250,-500,false,new int[1]{67},"Ranged",false,0.1f,120,5,10), //118
            ...
            new JsonNode("Damage",750,-575,false,new int[1]{120},"Ranged",false,0.15f,160,10,25), //121
            ...
            new JsonNode("Damage",25,-825,false,new int[1]{126},"Ranged",false,0.1f,120,5,10), //128
            ...
            new JsonNode("Damage",175,-975,false,new int[1]{132},"Ranged",false,0.15f,160,10,25), //133
            ...
            new JsonNode("Damage",-725,-650,false,new int[1]{140},"Throw",false,0.1f,120,10,10), //141
            ...
            new JsonNode("Damage",-825,-450,false,new int[1]{143},"Throw",false,0.15f,160,25,25), //144
